...
model_url = 'http://data.lip6.fr/cadene/pretrainedmodels/inceptionresnetv2-520b38e4.pth'
...
def inceptionresnetv2(dataset_numclasses, state_dict=None, pretrained='imagenet'):
