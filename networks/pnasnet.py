...
model_url = 'http://data.lip6.fr/cadene/pretrainedmodels/pnasnet5large-bf079911.pth'
...
def pnasnet5large(dataset_numclasses, state_dict=None, pretrained='imagenet'):
