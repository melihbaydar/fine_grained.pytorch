...
def inception_v3(dataset_numclasses, state_dict=None, pretrained=True, **kwargs):
...
class Inception3(nn.Module):
    ...
    def load_pretrained_network(self, dataset_numclasses):
        print('Loading pretrained model from {}..', model_urls['inception_v3_google'])
        ...
        if self.num_classes != dataset_numclasses:
            ...
            self.AuxLogits.fc = nn.Linear(self.AuxLogits.fc.in_features, dataset_numclasses)
